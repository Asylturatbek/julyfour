...
exports.init = async function() {
    return new Promise((resolve, reject) => {
        try {
            ...
            if (config.config.main.logMode && config.config.main.logMode == 'fluent') {
...
exports.rec = async function(errRec) {
    ...
    if (exports.logLevel == 'error') {
        if (logLabel == 'TRACE' || logLabel == 'DEBUG' || logLabel == 'INFO' || logLabel == 'WARNING') return;
    }
    ...
    // Записываем лог в Mongo
    if (logMode == "fluent") {
        dmzdb.insertLog(fileLog);
    }
...
exports.statEnd = function (statId) {
    ...
    if (foundInd==null) {
        exports.warn("Счетчик " + statId + " не найден в массиве счетчиков (" + currCounter + ")");
        return;
    }
